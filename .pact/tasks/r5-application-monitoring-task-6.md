...
verify: test -f lib/monitoring/adapters/neon/index.test.ts && test -f lib/monitoring/adapters/supabase/index.test.ts && npm test -- lib/monitoring/adapters/neon/index.test.ts lib/monitoring/adapters/supabase/index.test.ts lib/monitoring/adapters/conformance.test.ts && npm run typecheck
