...
verify: test -f app/monitoring/page.tsx && test -f 'app/monitoring/[project]/page.tsx' && test -f components/monitoring/monitoring-ui.test.tsx && npm test -- components/monitoring/monitoring-ui.test.tsx tests/smoke/app-shell.test.tsx && npm run typecheck && npm run lint
