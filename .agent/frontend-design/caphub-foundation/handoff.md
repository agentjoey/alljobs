...
Move `AGE-248` to `In Progress` and implement Task 7 from the approved Brief/mockup and development plan. Do not enable Caphub, restart services, deploy, push, merge, or cross the final P1-C production gate.
